...
#reader(lib "htdp-intermediate-lambda-reader.ss" "lang")((modname fixed-size-number-arithmetic) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f () #f)))
