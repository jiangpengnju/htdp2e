...
#reader(lib "htdp-beginner-reader.ss" "lang")((modname designing_world_programs) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f () #f)))
...
(define CAR-BODY (above (rectangle 35 5 "solid" "red")
