...
; Write down the data definitions for List-of-words. Systematically make up
; examples of Words and List-of-words. Finally, formulate the functional
; example from above with check-expect. Instead of working with full example,
; you may wish to start with a word of just two letters, say "d" and "e".
