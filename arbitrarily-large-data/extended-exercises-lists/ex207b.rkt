...
#reader(lib "htdp-beginner-abbr-reader.ss" "lang")((modname ex207b) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f () #f)))
; define the function block-generate, which randomly selects a
