...
#reader(lib "htdp-beginner-reader.ss" "lang")((modname a-graphical-editor-revisited.v4) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f () #f)))
; Design function: editor-render
