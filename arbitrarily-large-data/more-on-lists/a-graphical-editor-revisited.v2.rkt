...
#reader(lib "htdp-beginner-reader.ss" "lang")((modname a-graphical-editor-revisited.v2) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f () #f)))
; Design the world program of editor.
