...
#reader(lib "htdp-beginner-reader.ss" "lang")((modname programming-with-lists) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f () #f)))
